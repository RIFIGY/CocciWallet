...
//
//
//struct NftListView<Token:Contract>: View {
//    @Environment(\.dismiss) private var dismiss
//    @Environment(\.colorScheme) var colorScheme
//    @Environment(EthereumNetworkCard.self) private var card
//    
//    typealias NFTGroup = (Token, [NFT])
//
//    let tokens: [Token : [NFT]]
//    
...
//    }
//    
//    init?(nft: NFT?, contract: Token, title: String? = nil, onTap: ((NFTMetadata)->Void)? = nil ) where D == NFTDetailView {
//        guard let nft else {return nil}
//        self.model = .init(nft: nft, contract: contract)
//        self.title = title
//        if let onTap {
//            self.onTap = onTap
//        } else {
...
////#Preview {
////    NavigationStack {
////        NftListView(tokens: NFTs.preview.tokens)
