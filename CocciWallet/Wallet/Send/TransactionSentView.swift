...
struct TransactionSentView: View {
    ...
    var explorerURL: URL? {
        nil
//        guard let explorer = model.evm.explorerPrefix else {return nil}
...
//#Preview {
//    TransactionSentView(model: .init(evm: .ETH, address: Wallet.rifigy.address.string, decimals: 18), txHash: Wallet.rifigy.address.string)
