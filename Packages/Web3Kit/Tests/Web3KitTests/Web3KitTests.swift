...
//}
//private class TestStorage: PrivateKeyStorageProtocol {
...
//    }
//    
//    func loadPrivateKey<A>(for _: A) throws -> Data where A : ChainKit.Address {
//        self.privateKey.hexData!
//    }
//    
//    func storePrivateKey<A>(key: Data, with _: A) throws where A : ChainKit.Address {
//        
//    }
//    
...
final class Web3KitTests: XCTestCase {
    ...
    func testEthereumAccount() {
        XCTAssert(true)
//        let storage = TestStorage(privateKey: Ethereum.private_key_0)
//        let expectedAddress = Ethereum.address_0
//        let privateKey = Ethereum.private_key_0
//        
//        do {
//            let account = try Web3Kit.EthereumAccount.importAccount(into: storage, privateKey: privateKey, keystorePassword: "")
