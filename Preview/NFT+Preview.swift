...
extension ERC721.Token.Metadata {
    
    static var munko2309Metadata: ERC721.Token.Metadata { try! JSONDecoder().decode(ERC721.Token.Metadata.self, from: muko2309MetadataJSON) }
